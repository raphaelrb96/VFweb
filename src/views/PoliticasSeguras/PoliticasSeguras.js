import { AppBar, Container, Grid, IconButton, ThemeProvider, Toolbar, Typography, createTheme, makeStyles } from "@material-ui/core";
...
function AppBarPoliticas({ classes }) {
    return (
...
export default function PoliticasSeguras() {
    ...
    return (
        <ThemeProvider theme={theme}>
            <Container>
                ...
                <AppBarPoliticas classes={classes} />


                <Grid className={classes.content}>
                    <h2>Segurança do Usuario</h2>
                    <br />
                    ...
                    <h4>Modo e local de processamento dos dados</h4>
                    <h4>
