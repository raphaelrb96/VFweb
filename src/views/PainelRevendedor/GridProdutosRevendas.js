...
class ItemGridProduto extends React.Component {
    ...
    let nomeString = 'Por cada unidade vendida do ' + this.state.prodName;

    if (nomeString.length > 25) {
      nomeString = 'Por cada unidade vendida do ' +  this.state.prodName.substring(0, 25) + '...'
    }
...
export default function GridProdutosRevendas() {
	...
	return(
      ...
      <br/>
      <br/>
			<Title className={classes.center} >Produtos para revender</Title>
      <br/>
