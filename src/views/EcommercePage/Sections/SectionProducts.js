                    ...
                    <Card background style={{ backgroundImage: `url(${dg3})` }}>
                      <CardBody background>
                        ...
                        <Button href="/revendedor" round color="white">
                          <Subject /> Abrir Painel do Revendor
                        </Button>
                      </CardBody>
                    </Card>
                  </GridItem>
        ...
        <div className={classes.section}>
          <div className={classes.container}>
            ...
            <div className={classes.prods} > 
              <h2 className={classes.prods} >Resultados</h2>
              <br />
            </div>
              ...
              <GridItem md={12} sm={12}>
                <Grid container spacing={2} >
                  ...
                  {lista.map((item, i) => (
                    ...
                    <Produto indice={i} lista={lista} capa={item.get('imgCapa')} nome={item.get('prodName')} id={item.get('idProduto')} />
